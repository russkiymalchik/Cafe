        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <li class="scroll-to-section"  style="background-color: red; height: 40px">
                        

                    @auth

                <a style="color: white" href="{{url('/showcart',Auth::user()->id)}}">
...
<div  id="top" style="overflow-x: hidden;">
   ...
   @if(session()->has('message'))
    ...
    <h1 style="text-align: center; padding-bottom:15px; font-size: 40px">Cart Food</h1>
